  ...
  if (!data || data.recommendations.length === 0) {
    return (
      <div className="glass-card rounded-xl p-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/20">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Pratiquez 20 minutes par jour pour des résultats optimaux
              </p>
            </div>
            <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Terminez 3 ressources cette semaine
              </p>
            </div>
          </div>
        </div>
        <button
          onClick={fetchRecommendations}
          className="mt-4 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 transition-colors flex items-center mx-auto"
        >
